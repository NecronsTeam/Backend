...
namespace CrmBackend.Database.Migrations
{
    ...
    [Migration("20250111192020_AllChangesForPhotos")]
    partial class AllChangesForPhotos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActivityCompetence", b =>
                {
                    ...
                    b.HasKey("ActivitiesId", "CompetencesId");

                    b.HasIndex("CompetencesId");

                    b.ToTable("ActivityCompetence");
                });
            ...
            modelBuilder.Entity("ActivityCompetence", b =>
                {
                    ...
                    b.HasOne("CrmBackend.Database.Models.Competence", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CrmBackend.Database.Models.Account", b =>
                {
                    b.HasOne("CrmBackend.Database.Models.Photo", "Avatar")
                        .WithMany()
