...
namespace CrmBackend.Database.Migrations
{
    ...
    [Migration("20241201120516_NewTablesWithStudentInteractions")]
    partial class NewTablesWithStudentInteractions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrmBackend.Database.Models.StudentActivity", b =>
                {
                    b.HasOne("CrmBackend.Database.Models.User", "Activity")
                        .WithMany()
                        .HasForeignKey("ActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
